go-chart
========
[![CircleCI](https://circleci.com/gh/wcharczuk/go-chart.svg?style=svg)](https://circleci.com/gh/wcharczuk/go-chart) [![Go Report Card](https://goreportcard.com/badge/github.com/zshalex/go-chart)](https://goreportcard.com/report/github.com/zshalex/go-chart)
...
```bash
> go get -u github.com/zshalex/go-chart
```
...
import (
    ...
    "bytes"
    ...
    "github.com/zshalex/go-chart" //exposes "chart"
)
